...
gotiac:			switch (c) {
	...
	void
send_do(int option, int initial, int x)
{
	if (initial) {
...
willoption(int option, int x)
{
	...
	void
send_dont(int option, int initial, int x)
{
	if (initial) {
...
wontoption(int option, int x)
{
	...
	void
send_will(int option, int initial, int x)
{
	if (initial) {
...
dooption(int option, int x)
{
	...
	void
send_wont(int option, int initial, int x)
{
	if (initial) {
